...
def run_split_degree_bucket(degree_split, num_split, step, parameters):
	...
	if num_split == 1:
		...
		# ftime= (time02-time01) + (time022-time021) + (time003-time022) + (time021-time02)
		lbtime = time03-time003
		mtime = (time02-time01)
		pltime = (time003-time022) + (time021-time02)
...
def main():
	...
	argparser.add_argument('--num-split-degree', type=int, default=4) # $$$$$$$$$$$$$$$
